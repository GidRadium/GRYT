...
err_media_not_found = {"en": "Can't find this media.", "ru": "Не могу найти это медиа."}

err_download_media = {"en": "Media download error.", "ru": "Ошибка загрузки медиа."}

err_upload_media = {}

err_unknown_command = {"en": "Unknown command.", "ru": "Неизвестная команда."}
...
err_invalid_data_type = {"en": "Invalid data type.", "ru": "Недопустимый тип данных."}
